...
- [X] half floats
  ...
  Ok half float is being used, sadly it doenst really has much effect, only when buffers are really latge, and framerate is down to 100ms on rpi anyway
  then it does save 10/20% compared to glFloat
