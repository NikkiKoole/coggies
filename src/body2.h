...
enum BodyParts {
    BP_facing_north_head_000 = 0,
    BP_facing_east_head_000 = 1,
    BP_facing_south_head_000 = 2,
    BP_facing_west_head_000 = 3,
    BP_walking_north_body_000 = 4,
    BP_walking_north_body_001 = 5,
    BP_walking_east_body_000 = 6,
    BP_walking_east_body_001 = 7,
...
internal void fill_generated_complex_values(ComplexFrame* generated_frames ) {
    generated_frames[BP_facing_north_head_000] = (ComplexFrame){111, 0, 11, 17,2, 2, 9, 15, 13, 19, 6, 17, 6, 2};
    generated_frames[BP_facing_east_head_000] = (ComplexFrame){111, 17, 11, 17,2, 2, 9, 15, 13, 19, 6, 17, 6, 2};
